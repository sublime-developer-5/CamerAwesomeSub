...
- (void)setAutoExposureWithError:(FlutterError *_Nullable *_Nonnull)error;
- (void)setManualExposureIso:(NSInteger)iso exposureNs:(NSInteger)exposureNs error:(FlutterError *_Nullable *_Nonnull)error;
/// @return `nil` only when `error != nil`.
- (nullable IntRange *)getISORangeWithError:(FlutterError *_Nullable *_Nonnull)error;
/// @return `nil` only when `error != nil`.
- (nullable LongRange *)getExposureTimeRangeNsWithError:(FlutterError *_Nullable *_Nonnull)error;
- (void)setAutoWhiteBalanceWithError:(FlutterError *_Nullable *_Nonnull)error;
- (void)setWhiteBalanceTemperatureKelvin:(NSInteger)kelvin error:(FlutterError *_Nullable *_Nonnull)error;
- (void)setExposurePointPreviewW:(double)previewW previewH:(double)previewH x:(double)x y:(double)y error:(FlutterError *_Nullable *_Nonnull)error;
/// @return `nil` only when `error != nil`.
