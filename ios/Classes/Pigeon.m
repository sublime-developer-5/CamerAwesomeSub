...
@interface IntRange ()
+ (IntRange *)fromList:(NSArray<id> *)list;
+ (nullable IntRange *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end

@interface LongRange ()
+ (LongRange *)fromList:(NSArray<id> *)list;
+ (nullable LongRange *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end
...
+ (instancetype)makeWithMin:(NSInteger )min
    max:(NSInteger )max {
  IntRange* pigeonResult = [[IntRange alloc] init];
...
+ (IntRange *)fromList:(NSArray<id> *)list {
  IntRange *pigeonResult = [[IntRange alloc] init];
  pigeonResult.min = [GetNullableObjectAtIndex(list, 0) integerValue];
  pigeonResult.max = [GetNullableObjectAtIndex(list, 1) integerValue];
  return pigeonResult;
}
+ (nullable IntRange *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [IntRange fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    @(self.min),
...
@implementation LongRange
+ (instancetype)makeWithMin:(NSInteger )min
    max:(NSInteger )max {
  LongRange* pigeonResult = [[LongRange alloc] init];
  pigeonResult.min = min;
  pigeonResult.max = max;
  return pigeonResult;
}
...
+ (nullable LongRange *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [LongRange fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    @(self.min),
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 139: 
      return [IntRange fromList:[self readValue]];
    case 140: 
      return [LongRange fromList:[self readValue]];
    case 141: 
...
- (void)writeValue:(id)value {
  ...
  } else if ([value isKindOfClass:[IntRange class]]) {
    [self writeByte:139];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[LongRange class]]) {
    [self writeByte:140];
    [self writeValue:[value toList]];
...
void SetUpCameraInterfaceWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<CameraInterface> *api, NSString *messageChannelSuffix) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        ...
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setAutoExposureWithError:)], @"CameraInterface api (%@) doesn't respond to @selector(setAutoExposureWithError:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
        [api setAutoExposureWithError:&error];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        ...
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setManualExposureIso:exposureNs:error:)], @"CameraInterface api (%@) doesn't respond to @selector(setManualExposureIso:exposureNs:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        NSInteger arg_iso = [GetNullableObjectAtIndex(args, 0) integerValue];
        NSInteger arg_exposureNs = [GetNullableObjectAtIndex(args, 1) integerValue];
        FlutterError *error;
        [api setManualExposureIso:arg_iso exposureNs:arg_exposureNs error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        ...
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getISORangeWithError:)], @"CameraInterface api (%@) doesn't respond to @selector(getISORangeWithError:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
        IntRange *output = [api getISORangeWithError:&error];
        callback(wrapResult(output, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.CameraInterface.getExposureTimeRangeNs", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getExposureTimeRangeNsWithError:)], @"CameraInterface api (%@) doesn't respond to @selector(getExposureTimeRangeNsWithError:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
        LongRange *output = [api getExposureTimeRangeNsWithError:&error];
        callback(wrapResult(output, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.CameraInterface.setAutoWhiteBalance", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setAutoWhiteBalanceWithError:)], @"CameraInterface api (%@) doesn't respond to @selector(setAutoWhiteBalanceWithError:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
        [api setAutoWhiteBalanceWithError:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.CameraInterface.setWhiteBalanceTemperature", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setWhiteBalanceTemperatureKelvin:error:)], @"CameraInterface api (%@) doesn't respond to @selector(setWhiteBalanceTemperatureKelvin:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        NSInteger arg_kelvin = [GetNullableObjectAtIndex(args, 0) integerValue];
        FlutterError *error;
        [api setWhiteBalanceTemperatureKelvin:arg_kelvin error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.CameraInterface.setExposurePoint", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setExposurePointPreviewW:previewH:x:y:error:)], @"CameraInterface api (%@) doesn't respond to @selector(setExposurePointPreviewW:previewH:x:y:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        double arg_previewW = [GetNullableObjectAtIndex(args, 0) doubleValue];
        double arg_previewH = [GetNullableObjectAtIndex(args, 1) doubleValue];
        double arg_x = [GetNullableObjectAtIndex(args, 2) doubleValue];
        double arg_y = [GetNullableObjectAtIndex(args, 3) doubleValue];
        FlutterError *error;
        [api setExposurePointPreviewW:arg_previewW previewH:arg_previewH x:arg_x y:arg_y error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
