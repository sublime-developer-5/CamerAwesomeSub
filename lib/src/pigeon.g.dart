...
class IntRange {
  ...
  static IntRange decode(Object result) {
    result as List<Object?>;
    return IntRange(
      min: result[0]! as int,
      max: result[1]! as int,
...
class LongRange {
  ...
  static LongRange decode(Object result) {
    result as List<Object?>;
    return LongRange(
      min: result[0]! as int,
      max: result[1]! as int,
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 139: 
        return IntRange.decode(readValue(buffer)!);
      case 140: 
        return LongRange.decode(readValue(buffer)!);
      case 141: 
...
class CameraInterface {
  ...
  Future<void> setManualExposure(int iso, int exposureNs) async {
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[iso, exposureNs]) as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<IntRange> getISORange() async {
  ...
  Future<LongRange> getExposureTimeRangeNs() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camerawesome.CameraInterface.getExposureTimeRangeNs$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as LongRange?)!;
    }
  }

  Future<void> setAutoWhiteBalance() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camerawesome.CameraInterface.setAutoWhiteBalance$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> setWhiteBalanceTemperature(int kelvin) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camerawesome.CameraInterface.setWhiteBalanceTemperature$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[kelvin]) as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<void> setExposurePoint(double previewW, double previewH, double x, double y) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camerawesome.CameraInterface.setExposurePoint$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[previewW, previewH, x, y]) as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
      throw PlatformException(
