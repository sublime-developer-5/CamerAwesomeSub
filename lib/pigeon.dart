...
class CameraInterface {
  ...
  Future<void> setManualIso(double arg_iso) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
    ...
    final List<Object?>? replyList =
    await channel.send(<Object?>[arg_iso]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
  ...
  Future<void> setExposureBias(double arg_bias) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
      'dev.flutter.pigeon.CameraInterface.setExposureBias',
      codec,
      binaryMessenger: _binaryMessenger,
    );
    final List<Object?>? replyList =
  ...
  Future<void> setWhiteBalanceTemperature(double arg_kelvin) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
      'dev.flutter.pigeon.CameraInterface.setWhiteBalanceTemperature',
      codec,
      binaryMessenger: _binaryMessenger,
    );
    final List<Object?>? replyList =
    await channel.send(<Object?>[arg_kelvin]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
